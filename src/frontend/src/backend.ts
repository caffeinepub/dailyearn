...
export class Backend implements backendInterface {
    ...
    async addTask(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async completeTaskById(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeTaskById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByIds(arg0: Array<bigint>): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksByIds(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserTaskHistory(arg0: Principal): Promise<Array<TaskCompletion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserTaskHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        lastTaskCompletionDay: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.lastTaskCompletionDay)),
...
function from_candid_tuple_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _UserProfile]): [Principal, UserProfile] {
    return [
        value[0],
        from_candid_UserProfile_n4(_uploadFile, _downloadFile, value[1])
    ];
}
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        lastTaskCompletionDay: value.lastTaskCompletionDay ? candid_some(value.lastTaskCompletionDay) : candid_none(),
        totalEarnings: value.totalEarnings,
        streakCount: value.streakCount,
        balanceCents: value.balanceCents
    };
